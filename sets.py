...
def tag_special_ingredients(dish):
    ...
    be tracked are in the    SPECIAL_INGREDIENTS constant imported from
...
def singleton_ingredients(dishes, intersection):
    ...
    Each `<CATEGORY>_INTERSECTIONS` is an `intersection` of all dishes in the category. `<CATEGORY>`
    can be any one of:
